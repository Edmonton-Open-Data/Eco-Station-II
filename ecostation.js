           ...
           */
           ...
           charts
            ...
            barChart
                   ...
                   .margins({
                        ...
                        left:   Math.round(barChart.width() * 0.08, 1)
                    })
           ...
           lineChart
                   ...
                   .margins({
                        ...
                        right:  Math.round(lineChart.width() * 0.02, 1),
                        bottom: Math.round(lineChart.height() * 0.10, 1),
                        left:   Math.round(lineChart.width() * 0.08, 1)
                    })
                   .useViewBoxResizing(true)
                   .elasticY(true)
                   .brushOn(false)
